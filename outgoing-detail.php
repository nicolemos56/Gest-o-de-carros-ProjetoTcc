	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Gestão de categoria de carro</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Gestão de saida de carro</div>
                        ...
                        <div class="col-md-12">
                            ...
                            ?> 
								...
								<div class="form-group">
									<label>Número de registro de carro</label>
