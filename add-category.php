		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Adicionar nova categoria carro</div>
                        ...
                        <div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									<label>Descrição abreviado</label>
									<input type="text" class="form-control" id="sdesc" name="sdesc" required>
								</div>
