<?php
    ...
    if(isset($_POST['submit-in'])){
        ...
        if ($query) {
            $msg="Todos marcado e atualizado.";
        } else {
            $msg="Alguma coisa errado";
        }
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Gerir categoria do carro</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Geriri entrada de carro</div>
                            ...
                            ?> 
                                ...
                                <div class="form-group">
									...
									<select name="status" class="form-control" required="true" >
                                        <option value="Out">Saída de carro</option>
                                    </select>
								</div>
                        ...
                        <?php } ?>
									...
									<button type="submit" class="btn btn-success" name="submit-in">Enviar</button>
