...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Total Entrada</div>
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <p class="lead text-center"><?php echo "Total de Parque Selecionado " . date("Y/m/d") . "<br>"; ?></p>
							<div class="progress">
        ...
        <div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Entrada de hoje</div>
						<div class="panel-body">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <p class="lead text-center">Total de parque de hoje</p>
							<div class="progress">
        ...
        <div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Entradas de ontem</div>
						<div class="panel-body">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <p class="lead text-center">Total de parque de ontem</p>
							<div class="progress">
								<div data-percentage="0%" style="width: 20%;" class="progress-bar progress-bar-teal" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
