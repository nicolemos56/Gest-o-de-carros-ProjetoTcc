<?php
    ...
    include('includes/dbconn.php');
        ...
        if (strlen($_SESSION['vpmsaid']==0)) {
            ...
            if ($query) {
                $msg="Admin do perfil atualizado.";
        } else {
            $msg="Alguma coisa errado. Tenta novamente.";
            }
        }
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Admin Perfil</li>
			</ol>
		</div><!--/.row-->
						...
						$msg</div>" ?> 
							...
							<form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <center>
                                    <button type="submit" class="btn btn-info" name="submit-profile">alterar</button>
