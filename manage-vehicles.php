	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Gerir carro</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="panel panel-default">
					<div class="panel-heading">Entrar carro</div>
						...
						<div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									<label>Regitrar número</label>
									<input type="text" class="form-control" id="vehreno" name="vehreno" required>
								</div>
