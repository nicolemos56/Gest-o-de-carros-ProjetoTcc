<?php
    ...
    $eid=$_GET['editid'];
        ...
        {
        $msg="SAlguma coisa errada, tenta de novo";
        }
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default">
					<div class="panel-heading">Atualizar categoria de carro</div>
					<div class="panel-body">
						...
						<em class='fa fa-lg fa-close'>
                            ...
                            <?php }?>
									...
									<button type="submit" class="btn btn-success" name="update-category">Alterar</button>
								</div> <!--  col-md-12 ends -->
							</form>
						</div> 
					</div>
